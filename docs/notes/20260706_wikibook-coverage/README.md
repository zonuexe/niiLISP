...
| 3 | Lists | 45 | 0 | 0 | [03-lists.md](03-lists.md) |
| 4 | Strings | 29 | 0 | 6 | [04-strings.md](04-strings.md) |
...
- Missing helpers: `doargs` (ch. 2). *(Done 2026-07-06: `clean`, `index`, `exists`, `for-all`, `transpose`, `letn`, `letex`, `curry`, `global`/`global?`, `series`, `factor`, and the reference/query family `ref`/`ref-all`/`match`/`find-all`/`pop-assoc` under ADR-0036.)*
